...
pgm = daft.PGM(dpi=150, aspect=3.0, alternate_style="outer")

pgm.add_node("vitc", "Vitamin C", 0.7, 0.5, aspect=3.0, scale=1.0)
pgm.add_node("collagen", "Collagen\nSynthesis", 2.0, 0.5, aspect=3.0, scale=1.0)
pgm.add_node("scurvy", "Scurvy", 3.3, 0.5, aspect=3.0, scale=1.0)
