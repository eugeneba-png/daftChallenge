...
pgm = daft.PGM(dpi=150, aspect=2.6)
...
pgm.add_node("Lemons", "Lemons", 1.0, 1.0, aspect=2.6, scale=1.0, fontsize=10, plot_params=node_style)
pgm.add_node("Scurvy", "Scurvy", 3.1, 1.0, aspect=2.6, scale=1.0, fontsize=10, plot_params=node_style)

pgm.add_edge("Lemons", "Scurvy", plot_params={"linewidth": 1.2, "color": "black"})

fig = pgm.render()
plt.title("Simplified Lind's Model (1747)", loc="left", fontsize=12)
