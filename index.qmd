...
# Minimal black-and-white styling to match the reference image
pgm = daft.PGM(dpi=150, aspect=2.0, line_width=1.0, grid_unit=1.1, node_unit=0.85)
...
# Node positions chosen to reproduce the spacing in the reference
pgm.add_node("Lemons", "Lemons", 1.0, 1.0, aspect=2.4, scale=1.0, fontsize=7, plot_params=node_style)
pgm.add_node("Scurvy", "Scurvy", 3.0, 1.0, aspect=2.4, scale=1.0, fontsize=7, plot_params=node_style)

pgm.add_edge("Lemons", "Scurvy", plot_params={"linewidth": 1.0, "color": "black"})

fig = pgm.render()
plt.title("Simplified Lind's Model (1747)", loc="left", fontsize=10)
...
# Match the reference: simple white ellipses on a wider canvas.
pgm = daft.PGM(dpi=150, aspect=2.0, observed_style="inner", alternate_style="outer")
